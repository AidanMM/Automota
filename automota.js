	...
	calculateNextGeneration: function(){
		...
		break;
			...
			if(living > 0  ) {
				...
				this.neighbors[rand] != null ? this.neighbors[rand] = Corruption.create(this.neighbors[rand].xIndex, this.neighbors[rand].yIndex) : null;
			}
		}
			break;
		}
	...
	init: function(width, height, xSize, ySize) {
		...
		for(var x = 0; x < xSize; x++) {
			...
			for(var y = 0; y < ySize; y++) {
				this.automota[x][y] = Automota.create(x,y, "GoL");
			}
		}
